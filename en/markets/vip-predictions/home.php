...
<?php
	...
	$result = $mysqli->query ("SELECT match_id,score,league, game,time, betcode, odds_home, odds_draw, odds_away, vipprediction, vip FROM `match` WHERE vip = 'yes' AND date ='$date'");
