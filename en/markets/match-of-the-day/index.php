...
<script>
  ...
  gtag('config', 'UA-115818226-1');
    ...
    <title>Match of the Day - Matchora</title>
    <meta charset="UTF-8">
...
<section id="populara" class="BorderedSection">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="col-md-12 col-xs-12 col-sm-12 sectionHeader" data-aos="fade-right" data-aos-duration="1000">
                        <h2 class="SectionTitle RobotoMedium">Match of the Day</h2>
                        <div class="underTitleLine gradientbg"></div>
                        <p class="sectionDescription LightColor RobotoLight">
                            Here are our best matches of today<br>
	...
	$result = $mysqli->query ("SELECT match_id,score,league, game,time, betcode, odds_home, odds_draw, odds_away, tipoftheday, tipofthedayprediction FROM `match` WHERE tipoftheday = 'yes' AND date ='$date'");
	...
	while ($pow = $result->fetch_assoc()){
		...
		echo "<td>" . $pow ['game'] .  "</td>";
		echo "<td>" . $pow ['tipofthedayprediction'] .  "</td>";
