...
<script>
  ...
  gtag('config', 'UA-115818226-1');
    ...
    <title>Full Time Result Predictions - Matchora</title>
    <meta charset="UTF-8">
...
<section id="populara" class="BorderedSection">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="col-md-12 col-xs-12 col-sm-12 sectionHeader" data-aos="fade-right" data-aos-duration="1000">
                        <h2 class="SectionTitle RobotoMedium">Full Time Predictions</h2>
                        <div class="underTitleLine gradientbg"></div>
                        <p class="sectionDescription LightColor RobotoLight">
                            Here are matches with two way predictions,<br>
	...
	$result = $mysqli->query ("SELECT match_id,score,league, game,time, betcode, odds_home, odds_draw, odds_away, doublechance, doublechanceprediction FROM `match` WHERE doublechance = 'yes' AND date ='$date'");
	...
	if ($row<1){
			...
			echo "<span class=\"blink_me\">Still in progress</span>";
	}	
	else {
