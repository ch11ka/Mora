...
<script>
  ...
  gtag('config', 'UA-115818226-1');
    ...
    <title>Prediction Markets - Matchora</title>
    <meta charset="UTF-8">
...
<section id="populara" class="BorderedSection">
    <div class="container sectionPadding">
        <div class="row">
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="col-md-12 col-xs-12 col-sm-12 sectionHeader" data-aos="fade-right" data-aos-duration="1000">
                        <h2 class="SectionTitle RobotoMedium">Football Prediction Markets</h2>
                        <div class="underTitleLine gradientbg"></div>
                        <p class="sectionDescription LightColor RobotoLight">
                            All our markets are designed for your profit,<br>
                            select from a list of availaible markets
                        </p>
                    </div>
			...
			<div class="col-lg-3 col-md-3  col-sm-3 col-xs-6" style="padding-top:15px;">
                    <a href="https://matchora.com/markets/draws/"><img style="border-radius:10px" src="assets/images/draws.png" alt="draws" class="img-responsive"></a>
			...
			<div class="col-lg-3 col-md-3  col-sm-3 col-xs-6" style="padding-top:15px;">
                    <a href="https://matchora.com/markets/correct-score/"><img style="border-radius:10px" src="assets/images/correct-score.png" alt="correct score" class="img-responsive"></a>
			...
			<div class="col-lg-3 col-md-3  col-sm-3 col-xs-6" style="padding-top:15px;">
                    <a href="https://matchora.com/markets/halftime-fulltime/"><img style="border-radius:10px" src="assets/images/ht-ft.png" alt="Halftime-fulltime" class="img-responsive"></a>
               ...
               <div class="row-fluid">
                ...
                <div class="col-lg-3 col-md-3  col-sm-3 col-xs-6" style="padding-top:15px;">
                    <a href="https://matchora.com/markets/vip-predictions/"><img style="border-radius:10px" src="assets/images/vip.png" alt="Vip Predictions" class="img-responsive"></a>
			...
			<div class="col-lg-3 col-md-3  col-sm-3 col-xs-6" style="padding-top:15px;">
                    <a href="https://matchora.com/markets/20-odds/"><img style="border-radius:10px" src="assets/images/20-odds.png" alt="Double Chance" class="img-responsive"></a>
