...
<?php
	...
	$result = $mysqli->query ("SELECT match_id,score,league, game,time, betcode, odds_home, odds_draw, odds_away, over_0_5_firsthalf,fscores FROM `match` WHERE over_0_5_firsthalf = 'yes' AND date ='$date'");
