...
<script>
  ...
  gtag('config', 'UA-115818226-1');
    ...
    <title>Under and Over 3.5 Goals Predictions - Matchora</title>
    <meta charset="UTF-8">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="col-md-12 col-xs-12 col-sm-12 sectionHeader" data-aos="fade-right" data-aos-duration="1000">
                        <h2 class="SectionTitle RobotoMedium">3.5 Goals Predictions</h2>
                        <div class="underTitleLine gradientbg"></div>
                        <p class="sectionDescription LightColor RobotoLight">
                            Here are matches with Over and Under 3.5 predictions<br>
...
$mysqli = new mysqli('localhost', 'dindinda_match', 'BoxopusAquafeed!1', 'dindinda_matchora');
	...
	$result = $mysqli->query ("SELECT name,account,email,user_id,expiry FROM `users` WHERE email = '$email' AND (account = '3' OR account ='4' ) AND expiry >='$date'");
	
	$row= mysqli_num_rows($result);
	if ($row<1){
		
		
			include '../premiumessential.php';
	}	
	else {
