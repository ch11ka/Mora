...
<script>
  ...
  gtag('config', 'UA-115818226-1');
    ...
    <title>Halftime Fulltime Predictions - Matchora</title>
    <meta charset="UTF-8">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="col-md-12 col-xs-12 col-sm-12 sectionHeader" data-aos="fade-right" data-aos-duration="1000">
                        <h2 class="SectionTitle RobotoMedium">HalfTime Fulltime Predictions</h2>
                        <div class="underTitleLine gradientbg"></div>
                        <p class="sectionDescription LightColor RobotoLight">
                            Here are matches with HalfTime Fulltime predictions<br>
...
$mysqli = new mysqli('localhost', 'dindinda_match', 'BoxopusAquafeed!1', 'dindinda_matchora');
	...
	$result = $mysqli->query ("SELECT name,account,email,user_id,expiry FROM `users` WHERE email = '$email' AND account = '4' AND expiry >='$date'");
	
	$row= mysqli_num_rows($result);
	if ($row<1){
		
		
			include '../premiumpro.php';
	}	
	else {
