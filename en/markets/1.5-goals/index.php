...
<script>
  ...
  gtag('config', 'UA-115818226-1');
    ...
    <title>Over 1.5 Goals Predictions - Matchora</title>
    <meta charset="UTF-8">
...
<section id="populara" class="BorderedSection">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="row">
                    <div class="col-md-12 col-xs-12 col-sm-12 sectionHeader" data-aos="fade-right" data-aos-duration="1000">
                        <h2 class="SectionTitle RobotoMedium">Over 1.5 Goals Predictions</h2>
                        <div class="underTitleLine gradientbg"></div>
                        <p class="sectionDescription LightColor RobotoLight">
                            Here are matches with a high probability of over 1.5 goals,<br>
	...
	$result = $mysqli->query ("SELECT match_id,score,league, game,time, betcode, odds_home, odds_draw, odds_away, 1_5goals FROM `match` WHERE 1_5goals = 'yes' AND date ='$date'");
