...
<div class="wrapper">
	...
	$query= $mysqli-> query("SELECT * FROM `users` WHERE user_id >0 ");
	$row = mysqli_num_rows($query);
                                
                    
		?>        	
                                <h2 class="counter"> <?php echo $row;?></h2>
                                <span>Total Registered Users</span>
                            </div>
                        </div>
                        <div class="bg-dark-primary">
                            <p class="week-sales">Total Registered Users</p>
	...
	$jquery= $mysqli-> query("SELECT DATE_FORMAT(created,'%M %Y' ) FROM  `users` WHERE (DATE_FORMAT(created,'%M %Y' )='$date') ");
	$how = mysqli_num_rows($jquery);
                                
      
                    
		?>        	
                                <h2 class="counter"><?php echo $how;?></h2>
                                <span>New Users This Month</span>
                            </div>
                        </div>
                        <div class="bg-dark-success">
                            <p class="week-sales">New Users This Month</p>
                            <p class="total-sales "></p>
                        </div>
                    </div>
                </div>
	...
	$jquery= $mysqli-> query("SELECT DATE_FORMAT(LPaymentDate,'%M %Y' ) FROM  `users` WHERE (DATE_FORMAT(LPaymentDate,'%M %Y' )='$date') ");
	$jow = mysqli_num_rows($jquery);
                                
                                ?>
                                <h2 class="counter"><?php echo $jow;?></h2>
                                <span>Paid Users This Month</span>
                            </div>
                        </div>
                        <div class="bg-dark-warning">
                            <p class="week-sales">Paid Users This Month</p>
                            <p class="total-sales"></p>
                        </div>
                    </div>
                </div>
