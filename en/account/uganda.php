...
<!--//BASIC STARTS HERE-->
                    <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">UGX 56,000 </p>
  ...
  <input type="hidden" name="dusupay_amount" value="56000" optional>
                     ...
                     <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">UGX 75,000 </p><p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="75000" optional>
  <input type="hidden" name="dusupay_currency" value="UGX" required>
                     ...
                     <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">UGX 110,000</p>
                                <p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="110000" optional>
  <input type="hidden" name="dusupay_currency" value="UGX" required>
...
<div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">UGX 260,000</p>
                                <p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="260000" optional>
  <input type="hidden" name="dusupay_currency" value="UGX" required>
...
<div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">UGX 185,000</p>
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="185000" optional>
  <input type="hidden" name="dusupay_currency" value="UGX" required>
