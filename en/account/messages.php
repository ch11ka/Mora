...
define('USER_REGISTRATION_SUCCESS', 'SUCCESS!!!, Please check your E-mail'); //Check your email to Verify your account


define('LOGIN_FIELDS_MISSING', 'Email and Password are missing');
define('LOGIN_FAIL', 'Email or Password is Incorrect!'); //OR Email has not been verified!
