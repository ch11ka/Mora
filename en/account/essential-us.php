                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;"> $30 </p>
                            ...
                            <div class="content ">
											...
											Access to Essential package markets<br>
											Over 85% Accuracy<br>
...
<input type="hidden" name="hosted_button_id" value="LGER5JVY5X9XY">
