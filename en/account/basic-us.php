...
<input type="hidden" name="hosted_button_id" value="ARNPCPRPEUTQL">
                     ...
                     <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">$20 </p><p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                              
											<p class="text-center" style="font-size: 14px;line-height: 30px">Daily E-mails of 4 Sure Games<br>
											Access to Basic markets<br>
											Over 85% Accuracy<br>
											Receive Via E-mails
											<br><br>
