...
<!--//BASIC STARTS HERE-->
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="footer">
							<form action="paystack-pro" method="post">
                            	<p class="text-center">
                     ...
                     <div class="col-md-6">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">N 5,000 </p><p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
