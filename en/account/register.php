...
<body>
			...
			<div class="row">
					...
					<div class="col-sm-12">
						<div class="login-card card-block bg-white">
							<form  method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="md-float-material" id="register-form">
									...
									<div class="row">
										<div class="col-sm-12">
												<div class="md-input-wrapper">
													<input name="name" type="text" class="md-form-control cleanup" required="">
										...
										<div class="md-input-wrapper">
											<input name="email" id="email" type="email" class="md-form-control cleanup" required="">
										...
										<div class="md-input-wrapper">
											<input name="number" type="text" class="md-form-control cleanup" required="">
												
											<label>Phone Number</label>
										</div>
										
										<div class="md-input-wrapper">
										<select name="country" id="email" class="md-form-control">
    ...
    <option value="Zimbabwe">Zimbabwe</option>
										...
										<div class="md-input-wrapper">
											<input name="password" type="password" class="md-form-control cleanup" required="">
							...
							<center><p><b>Any issues reach us on +2348105354705</b></p></center>
										</div>
									</div>
							</form>
							<!-- end of form -->
