                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                <h1 class=" text-center" style="color:white;">PAY ONLINE <hr style="width: 30px;"></h1>
                            ...
                            <div class="footer">
							<form action="paystack-basic" method="post">
                            	<p class="text-center">
								
                            	<button class="btn btn-danger btn-md text-center" type="submit" name="submit" style="margin-top: -10px;margin-bottom: 20px;">PAY NOW </button></p>
								</form>
                            </div>
                        </div>
                    </div>
...
<!--CLASSIC STARTS HERE-->
                     ...
                     <div class="col-md-6">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                <h1 class=" text-center" style="color:white;">BANK PAYMENT <hr style="width: 30px;"></h1>
                                <p class="text-center" style="color:white;font-size: 20px;">N 2,000 </p><p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                              
											<p class="text-center" style="font-size: 14px;line-height: 30px"><b>MATCHORA DIGITAL SERVICES</b><br>
											<b>1015598629</b><br>
											<b>Zenith Bank</b><br>
											<b>Current Account</b> <br>
											<b>**Send your details to +234 8105354705 after payment **</b>
											</p>
                            ...
                            <div class="footer">
                            	<p class="text-center">
                            	<a class="btn btn-md btn-warning text-center  disabled" href="" style="margin-top: -10px;margin-bottom: 20px;">Upgrade</a></p>
                            </div>
                        </div>
					</div>
