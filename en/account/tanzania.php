...
<!--//BASIC STARTS HERE-->
                    <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">TZS 35,000 </p>
  ...
  <input type="hidden" name="dusupay_amount" value="35000" optional>
  <input type="hidden" name="dusupay_currency" value="TZS" required>
                     ...
                     <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">TZS 46,000 </p><p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="46000" optional>
  <input type="hidden" name="dusupay_currency" value="TZS" required>
                     ...
                     <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">TZS 69,000</p>
                                <p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="69000" optional>
  <input type="hidden" name="dusupay_currency" value="TZS" required>
...
<div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">TZS 160,000</p>
                                <p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="160000" optional>
  <input type="hidden" name="dusupay_currency" value="TZS" required>
...
<div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">TZS 115,000</p>
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="115000" optional>
  <input type="hidden" name="dusupay_currency" value="TZS" required>
