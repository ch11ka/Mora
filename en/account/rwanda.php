...
<!--//BASIC STARTS HERE-->
                    <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">RWF 13,000 </p>
  ...
  <input type="hidden" name="dusupay_amount" value="13000" optional>
  <input type="hidden" name="dusupay_currency" value="RWF" required>
                     ...
                     <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">RWF 17,000 </p><p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="17000" optional>
  <input type="hidden" name="dusupay_currency" value="RWF" required>
                     ...
                     <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">RWF 25,000</p>
                                <p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="25000" optional>
  <input type="hidden" name="dusupay_currency" value="RWF" required>
...
<div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">RWF 60,000</p>
                                <p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="60000" optional>
  <input type="hidden" name="dusupay_currency" value="RWF" required>
...
<div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">RWF 42,000</p>
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="42000" optional>
  <input type="hidden" name="dusupay_currency" value="RWF" required>
