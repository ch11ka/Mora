...
<!--//BASIC STARTS HERE-->
                    <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">XAF 8,000 </p>
  ...
  <input type="hidden" name="dusupay_amount" value="8000" optional>
  <input type="hidden" name="dusupay_currency" value="XAF" required>
                     ...
                     <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">XAF 11,000 </p><p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="11000" optional>
  <input type="hidden" name="dusupay_currency" value="XAF" required>
                     ...
                     <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">XAF 16,000</p>
                                <p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="16000" optional>
  <input type="hidden" name="dusupay_currency" value="XAF" required>
...
<div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">XAF 38,000</p>
                                <p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="38000" optional>
  <input type="hidden" name="dusupay_currency" value="XAF" required>
...
<div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">XAF 27,000</p>
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="27000" optional>
  <input type="hidden" name="dusupay_currency" value="XAF" required>
