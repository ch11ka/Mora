               ...
               <center>
                            ...
                            <!--<p class="category">Select your correct country to prevent errors in transactions as there would be no refunds for erring </p>--> <br>
                             ...
                             <!--<p class="category">We are launching this service soon!</p>-->
                               ...
                               <div style="padding-top:20px; max-width:400px">
							    Your payment has been received. <br>Kindly send us a message on Whatsapp +234 8105354705 or E-mail support@matchora.com with a payment confirmation.
                            </div>
                               <br><br>
                               <!--<b style="color:red">RECOMMENDED BROWSERS ARE GOOGLE CHROME & MOZILLA</b>--><br><br>
