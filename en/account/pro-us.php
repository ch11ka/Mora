                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="content ">
											...
											Access to PRO package markets<br>
											Over 85% Accuracy<br>
...
<input type="hidden" name="hosted_button_id" value="HF6PB6VFSXRNU">
                     ...
                     <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">$50 </p><p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
