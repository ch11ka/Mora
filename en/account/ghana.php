                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">GHS 40 </p>
							...
							<center>
                            	<p class="text-center">
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="40" optional>
  <input type="hidden" name="dusupay_currency" value="GHS" required>
  <input type="hidden" name="dusupay_itemId" value="Basic" required>
  <input type="hidden" name="dusupay_itemName" value="Basic Plan" required>
  <input type="hidden" name="dusupay_transactionReference" value="<?= $transref ?>" required>
  <input type="hidden" name="dusupay_redirectURL" value="https://matchora.com/account/paypal-success" optional>
...
<!--CLASSIC STARTS HERE-->
                     ...
                     <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">GHS 50 </p><p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
  ...
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="50" optional>
  <input type="hidden" name="dusupay_currency" value="GHS" required>
  <input type="hidden" name="dusupay_itemId" value="Essential" required>
  <input type="hidden" name="dusupay_itemName" value="Essential Plan" required>
  <input type="hidden" name="dusupay_transactionReference" value="<?= $transref ?>" required>
  <input type="hidden" name="dusupay_redirectURL" value="https://matchora.com/account/paypal-success" optional>
  <input type="hidden" name="dusupay_successURL" value="" optional>
  <!--<input type="hidden" name="dusupay_logo" value="" optional>-->
                     ...
                     <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">GHS 80</p>
                                <p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="80" optional>
  <input type="hidden" name="dusupay_currency" value="GHS" required>
  <input type="hidden" name="dusupay_itemId" value="PRO" required>
  <input type="hidden" name="dusupay_itemName" value="PRO Plan" required>
  <input type="hidden" name="dusupay_transactionReference" value="<?= $transref ?>" required>
  <input type="hidden" name="dusupay_redirectURL" value="https://matchora.com/account/paypal-success" optional>
  <input type="hidden" name="dusupay_successURL" value="" optional>
  <!--<input type="hidden" name="dusupay_logo" value="" optional>-->
...
<div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">GHS 265</p>
                                <p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="260" optional>
  <input type="hidden" name="dusupay_currency" value="GHS" required>
  <input type="hidden" name="dusupay_itemId" value="VIP" required>
  <input type="hidden" name="dusupay_itemName" value="VIP Plan" required>
  <input type="hidden" name="dusupay_transactionReference" value="<?= $transref ?>" required>
  <input type="hidden" name="dusupay_redirectURL" value="https://matchora.com/account/paypal-success" optional>
  <input type="hidden" name="dusupay_successURL" value="" optional>
  <!--<input type="hidden" name="dusupay_logo" value="" optional>-->
...
<div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">GHS 100</p>
                            ...
                            <div class="footer">
                            	...
                            	<form method="post" action="https://dusupay.com/dusu_payments/dusupay" target="_blank">
  <input type="hidden" name="dusupay_merchantId" value="2613" required>
  <input type="hidden" name="dusupay_amount" value="100" optional>
  <input type="hidden" name="dusupay_currency" value="GHS" required>
  <input type="hidden" name="dusupay_itemId" value="Weekend" required>
  <input type="hidden" name="dusupay_itemName" value="Weekend Plan" required>
  <input type="hidden" name="dusupay_transactionReference" value="<?= $transref ?>" required>
  <input type="hidden" name="dusupay_redirectURL" value="https://matchora.com/account/paypal-success" optional>
  <input type="hidden" name="dusupay_successURL" value="" optional>
  <!--<input type="hidden" name="dusupay_logo" value="" optional>-->
