                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">N 2,000 </p>
                            ...
                            <div class="footer">
                            	<p class="text-center">
                            	<a class="btn btn-warning btn-md btn-fill text-center" style="margin-top: -10px;margin-bottom: 20px;" href="nigeria-basic">Upgrade</a></p>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px; ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">N 3,000 </p><p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	<p class="text-center">
                            	<a class="btn btn-md btn-warning text-center" style="margin-top: -10px;margin-bottom: 20px;" href="nigeria-essential">Upgrade</a></p>
                            </div>
                        </div>
					</div>
                     ...
                     <div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">N 5,000</p>
                                <p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	<p class="text-center">
                            	<a class="btn btn-warning btn-md btn-fill text-center" style="margin-top: -10px;margin-bottom: 20px;" href="nigeria-pro">Upgrade</a></p>
                            </div>
                        </div>
                    </div>
...
<div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">N 20,000</p>
                                <p class="text-center" style="color:white;font-size: 20px;">Monthly</p>
                            </div>
                            <div class="content ">
                            ...
                            <div class="footer">
                            	<p class="text-center">
                            	<a class="btn btn-warning btn-md btn-fill text-center" style="margin-top: -10px;margin-bottom: 20px;" href="nigeria-vip">Upgrade</a></p>
                            </div>
                        </div>
                    </div>	
...
<div class="col-md-4">
                        <div class="card">
                            <div class="header" style="background-color:#C83171;padding-bottom: 30px;padding-top: 30px;  ">
                                ...
                                <p class="text-center" style="color:white;font-size: 20px;">N 7,000</p>
                            ...
                            <div class="footer">
                            	<p class="text-center">
                            	<a class="btn btn-warning btn-md btn-fill text-center" style="margin-top: -10px;margin-bottom: 20px;" href="nigeria-weekend">Upgrade</a></p>
                            </div>
                        </div>
                    </div>						
				</div>
