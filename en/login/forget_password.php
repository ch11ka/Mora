...
<html lang="en">
  ...
  <?php
	if (isset($_POST["submit"])) {
		...
		$result='<div class="alert alert-success">New password sent to your email. Check in 5 Minutes</div>';
	...
	<div class="container">
		...
		<div class="login-form">
			...
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>" id="forgetpassword-form" method="post"  class="form-register" role="form">
				...
				<button class="btn btn-block bt-login" type="submit" name="submit">Reset Password</button>
				<br>
			</form>
